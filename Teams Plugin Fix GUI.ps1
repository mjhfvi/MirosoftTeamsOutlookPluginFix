...
# Create a new form
$LocalTeamForm                    = New-Object system.Windows.Forms.Form

# Define the size, title and background color
$LocalTeamForm.ClientSize         = '500,300'
$LocalTeamForm.text               = "Microsoft Teams Outlook Plugin Fix"
$LocalTeamForm.BackColor          = "#ffffff"


$LocalTeamForm                    = New-Object system.Windows.Forms.Form
$LocalTeamForm.ClientSize         = New-Object System.Drawing.Point(400,400)
$LocalTeamForm.text               = "Microsoft Teams Outlook Plugin Fix"
$LocalTeamForm.TopMost            = $false

$Label1                          = New-Object system.Windows.Forms.Label
$Label1.text                     = "Microsoft Teams Outlook Plugin Fix"
$Label1.AutoSize                 = $true
$Label1.width                    = 45
$Label1.height                   = 20
$Label1.location                 = New-Object System.Drawing.Point(34,132)
$Label1.Font                     = New-Object System.Drawing.Font('Microsoft Sans Serif',13)

$PictureBox1                     = New-Object system.Windows.Forms.PictureBox
$PictureBox1.width               = 400
$PictureBox1.height              = 50
$PictureBox1.location            = New-Object System.Drawing.Point(76,20)
$PictureBox1.imageLocation       = "D:\Logo.jpg"
$PictureBox1.SizeMode            = [System.Windows.Forms.PictureBoxSizeMode]::AutoSize

$SendData                        = New-Object system.Windows.Forms.Button
$SendData.text                   = "Run The Fix"
$SendData.width                  = 166
$SendData.height                 = 75
$SendData.location               = New-Object System.Drawing.Point(126,252)
$SendData.Font                   = New-Object System.Drawing.Font('Microsoft Sans Serif',10)


$LocalTeamForm.controls.AddRange(@($Label1,$PictureBox1,$SendData))
